...
module.exports = function(source, options){
  ...
  let usingAccount = db('accounts').find({using: true})
  ...
  const accessKey = usingAccount.accessKey
  const secretKey = usingAccount.secretKey
  const origin = usingAccount.bucket[bucket]
